...
1. **What is the current issue scope?**
   Describe in one or two sentences what you are working on right now and what "done" looks like for this task.

2. **What does this new idea add?**
   Describe the new idea and how it relates (or does not relate) to the current scope.
